...
class XRFactorLoopTest extends RulpTestBase {
	...
	void test1() {
		...
		_test("(loop (setq x (- x 1)) (print x) (print ,) (when (< x 2) (break)))", "nil", "4,3,2,1,");
		...
		_test("(loop for x from 1 to 3 do (print x) (print 1))", "nil", "112131");
	}
	...
	void test2() {
		...
		_test("(loop for x in '(1 2 3 4) do (if (= x 3) (break)) (print x) (print ,))", "nil", "1,2,");
	}
