...
class FileUtilTest extends RulpTestBase {

	@Test
	public void test_copyByChannel() {
	...
	public void test_toValidPath() {
		...
		if (SystemUtil.getOSType() == OSType.Win) {
			...
			assertEquals("/home/todd/data/project/itool/iCommon/", FileUtil.toValidPath(null));
		}
	}
	...
	public void test_isAbsPath() {
		...
		if (SystemUtil.getOSType() == OSType.Win) {
			...
			assertTrue(FileUtil.isAbsPath("D:\\"));
