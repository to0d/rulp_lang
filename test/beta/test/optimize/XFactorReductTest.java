...
class XFactorReductTest extends RulpTestBase {
	...
	@Test
	void test_reduct_4_multi_3_const() {
	...
	@Test
	void test_reduct_6_add_3() {
		_setup();
		_run_script();
	}

	@Test
	void test_reduct_6_add_4() {
		_setup();
		_run_script();
	}

	@Test
	void test_reduct_6_add_5_const() {
		_setup();
		_run_script();
	}
	...
	@Test
	void test_reduct_6_by_2() {
		_setup();
		_run_script();
	}

	@Test
	void test_reduct_6_by_3() {
		_setup();
		_run_script();
	}
	...
	@Test
	void test_reduct_7_relational_1() {
		_setup();
		_run_script();
	}

	@Test
	void test_reduct_7_relational_2() {
		_setup();
		_run_script();
	}
}
